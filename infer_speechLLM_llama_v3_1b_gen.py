...
if __name__ == "__main__":
    ...
    ckpt_path = './exp4/streamingLLM_llama1b_CIFwithQuantityLoss_prompt/libri100_speechLLM_llama1b/epoch=10.ckpt' 
    ...
    for dataset in val_sets:
        ...
        for idx, batch in enumerate(tqdm(val_sets[dataset])):
            with torch.no_grad():
                ...
                print("extracted_pred: ", extracted_pred)
                print("extracted_target: ", extracted_target)
